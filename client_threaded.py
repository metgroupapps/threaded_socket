...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sck:
	...
	while True:
		...
		msg2 = b'\x08\x00\x00\x00\x00\x00\x01\xbeR\x00\x00\x00{"MODULE":"EVEM","OPERATION":"SENDALARMINFO","PARAMETER":{"ALARMAS":1,"ALARMCOUNT":1,"ALARMTYPE":56,"ALARMUID":8,"CMDNO":158334999,"CMDTYPE":0,"CURRENTTIME":1588897013,"EVTUUID":"2b0b1d17-8cb3-4221-b17d-92490bd26fd6","L":1,"LEV":1,"P":{"C":34880,"J":"-74.109395","S":0,"T":"20200508051653","V":0,"W":"4.708228"},"RUN":2416,"S":null,"SP":0,"ST":1,"STORAGEINDEX":1,"TRIGGERTYPE":1},"SESSION":"ccd944ec-289e-422c-ba25-36e9d7f31483","TYPE":"NOTIFY"}\n'
		sck.sendall(msg2)
		time.sleep(args.timeout)
		if msg2 =='exit':
