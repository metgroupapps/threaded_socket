...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sck:
	...
	while True:
		...
		print(1)
		data1 = sck.recv(1024)
		print("The server's response was: {}".format(data1))
		time.sleep(1)
		...
		print(2)
		data2 = sck.recv(1024)
		print("The server's response was: {}".format(data2))
		time.sleep(1)
		msg3 = b'\x08\x00\x00\x00\x00\x00\x00\x8eR\x00\x00\x00{"MODULE":"CONFIGMODEL","OPERATION":"SET","RESPONSE":{"ERRORCAUSE":"SUCCESS","ERRORCODE":0},"SESSION":"a29dc111-1ee4-43fa-afeb-c838c1f77f51"}\n\x08\x00\x00\x00\x00\x00\x01\xc2R\x00\x00\x00{"MODULE":"EVEM","OPERATION":"SENDALARMINFO","PARAMETER":{"ALARMAS":1,"ALARMCOUNT":1,"ALARMTYPE":56,"ALARMUID":19,"CMDNO":154009639,"CMDTYPE":1,"CURRENTTIME":1590870920,"EVTUUID":"41089c27-ccc9-4761-aea3-b0349cec4867","L":1,"LEV":1,"P":{"C":20750,"J":"-74.072631","S":3400,"T":"20200531013520","V":0,"W":"4.615833"},"RUN":2350,"S":null,"SP":0,"ST":3,"STORAGEINDEX":3,"TRIGGERTYPE":1},"SESSION":"a29dc111-1ee4-43fa-afeb-c838c1f77f51","TYPE":"NOTIFY"}\n'
		sck.sendall(msg3)
		print(3)
		data3 = sck.recv(1024)
		print("The server's response was: {}".format(data3))
		#time.sleep(1)
